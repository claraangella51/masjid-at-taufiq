            ...
            if (isInfak)
              Column(
                ...
                children: [
                  ...
                  const Text("Terkumpul Rp 4.500.000 dari target Rp 7.000.000"),
                ],
              ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  if (!isZakatFitrah && namaController.text.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text("Masukkan nama donatur")),
                    );
                    return;
                  }
                  ...
                  showDialog(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: Text(
                        "Kategori : ${["Zakat", "Infak", "Fidyah"][kategoriIndex]}\n"
                        "Jenis : $zakatType\n"
                        "Nominal : ${formatRupiah(nominal == 0 ? int.tryParse(nominalController.text) ?? 0 : nominal)}",
                      ),
                    ),
                  );
                },
